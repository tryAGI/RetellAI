...
namespace RetellAI
{
    ...
    public sealed partial class AgentSwapTool
    {
        ...
        public global::RetellAI.AgentSwapToolType Type { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.AgentSwapToolExecutionMessageTypeJsonConverter))]
