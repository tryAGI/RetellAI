    ...
    public class CreateConversationFlowComponentRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.CreateConversationFlowComponentRequest>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (value.IsConversationFlowComponent)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ConversationFlowComponent), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.ConversationFlowComponent?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.ConversationFlowComponent).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ConversationFlowComponent!, typeInfo);
            }
            else if (value.IsCreateConversationFlowComponentRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.CreateConversationFlowComponentRequestVariant2!, typeInfo);
            }
        }
    }
}