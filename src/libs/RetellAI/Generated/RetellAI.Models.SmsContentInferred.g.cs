...
namespace RetellAI
{
    ...
    public sealed partial class SmsContentInferred
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.SmsContentInferredTypeJsonConverter))]
        public global::RetellAI.SmsContentInferredType? Type { get; set; }
        ...
        public SmsContentInferred(
            global::RetellAI.SmsContentInferredType? type,
            string? prompt)
        {
            this.Type = type;
            this.Prompt = prompt;
