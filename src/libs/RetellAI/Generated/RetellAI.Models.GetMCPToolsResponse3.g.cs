...
namespace RetellAI
{
    ...
    public sealed partial class GetMCPToolsResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.GetMCPToolsResponseStatus3JsonConverter))]
        public global::RetellAI.GetMCPToolsResponseStatus3? Status { get; set; }
        ...
        public GetMCPToolsResponse3(
            global::RetellAI.GetMCPToolsResponseStatus3? status,
            string? message)
        {
            this.Status = status;
