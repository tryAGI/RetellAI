...
namespace RetellAI
{
    ...
    public sealed partial class TestCaseDefinitionInput
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.RetellResponseEngineJsonConverter))]
        public global::RetellAI.RetellResponseEngine? ResponseEngine { get; set; }
        ...
        public global::RetellAI.LLMModel? LlmModel { get; set; }
        ...
        public TestCaseDefinitionInput(
            ...
            global::RetellAI.LLMModel? llmModel)
        {
            this.Name = name;
