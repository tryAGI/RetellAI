...
namespace RetellAI
{
    ...
    public sealed partial class UpdateChatAgentResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.UpdateChatAgentResponseStatus3JsonConverter))]
        public global::RetellAI.UpdateChatAgentResponseStatus3? Status { get; set; }
        ...
        public UpdateChatAgentResponse3(
            global::RetellAI.UpdateChatAgentResponseStatus3? status,
            string? message)
        {
            this.Status = status;
