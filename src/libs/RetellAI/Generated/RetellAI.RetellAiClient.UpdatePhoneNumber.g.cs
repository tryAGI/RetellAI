...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement s_UpdatePhoneNumberSecurityRequirement0 =
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement[] s_UpdatePhoneNumberSecurityRequirements =
            new global::RetellAI.EndPointSecurityRequirement[]
            {                s_UpdatePhoneNumberSecurityRequirement0,
            };
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.PhoneNumberResponse> UpdatePhoneNumberAsync(
            string phoneNumber,
        ...
        {
            var __response = await UpdatePhoneNumberAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.PhoneNumberResponse>> UpdatePhoneNumberAsResponseAsync(
            string phoneNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::RetellAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdatePhoneNumberSecurityRequirements,
                operationName: "UpdatePhoneNumberAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::RetellAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdatePhoneNumberAsync",
                                pathTemplate: "$\"/update-phone-number/{phoneNumber}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::RetellAI.UpdatePhoneNumberResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::RetellAI.UpdatePhoneNumberResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdatePhoneNumberResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::RetellAI.UpdatePhoneNumberResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::RetellAI.UpdatePhoneNumberResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdatePhoneNumberResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::RetellAI.UpdatePhoneNumberResponse3? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::RetellAI.UpdatePhoneNumberResponse3.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdatePhoneNumberResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::RetellAI.UpdatePhoneNumberResponse4? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::RetellAI.UpdatePhoneNumberResponse4.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdatePhoneNumberResponse4>.Create(
                                    statusCode: __response.StatusCode,
