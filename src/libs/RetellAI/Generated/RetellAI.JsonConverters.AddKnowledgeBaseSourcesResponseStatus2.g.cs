...
{
    /// <inheritdoc />
    public sealed class AddKnowledgeBaseSourcesResponseStatus2JsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.AddKnowledgeBaseSourcesResponseStatus2>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            writer.WriteStringValue(global::RetellAI.AddKnowledgeBaseSourcesResponseStatus2Extensions.ToValueString(value));
        }
    }
}
