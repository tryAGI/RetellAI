...
{
    /// <inheritdoc />
    public class V2CallResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.V2CallResponse>
    {
        /// <inheritdoc />
        public override global::RetellAI.V2CallResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.V2WebCallResponse), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.V2PhoneCallResponse), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::RetellAI.V2WebCallResponse? web = default;
            global::RetellAI.V2PhoneCallResponse? phone = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::RetellAI.V2CallResponse(
                web,
        ...
        public override void Write(
            ...
            global::RetellAI.V2CallResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
