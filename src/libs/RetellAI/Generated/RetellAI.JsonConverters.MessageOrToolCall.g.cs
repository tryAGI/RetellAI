...
{
    /// <inheritdoc />
    public class MessageOrToolCallJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.MessageOrToolCall>
    {
        /// <inheritdoc />
        public override global::RetellAI.MessageOrToolCall Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.Message), options);
            ...
            var __score1 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ToolCallInvocationMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score2 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ToolCallResultMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score3 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.NodeTransitionMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score4 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.StateTransitionMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score5 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.InjectedMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            var __score6 = 0;
            {
                var __ti = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.SmsMessage), options);
                if (__ti != null && __ti.Kind == global::System.Text.Json.Serialization.Metadata.JsonTypeInfoKind.Object)
                {
                    foreach (var __prop in __ti.Properties)
                    {
            ...
            global::RetellAI.Message? message = default;
            global::RetellAI.ToolCallInvocationMessage? invocation = default;
            global::RetellAI.ToolCallResultMessage? result = default;
            global::RetellAI.NodeTransitionMessage? nodeTransition = default;
            global::RetellAI.StateTransitionMessage? stateTransition = default;
            global::RetellAI.InjectedMessage? injected = default;
            global::RetellAI.SmsMessage? sms = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 5)
                {
                    try
                    {
                        ...
                        injected = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (message == null && invocation == null && result == null && nodeTransition == null && stateTransition == null && injected == null && sms == null)
            {
                try
                {
            ...
            var __value = new global::RetellAI.MessageOrToolCall(
                message,
        ...
        public override void Write(
            ...
            global::RetellAI.MessageOrToolCall value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
