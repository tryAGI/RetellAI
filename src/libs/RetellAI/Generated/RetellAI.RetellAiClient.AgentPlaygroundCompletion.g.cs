...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        {
            var __response = await AgentPlaygroundCompletionAsResponseAsync(
                agentId: agentId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.AgentPlaygroundCompletionResponse>> AgentPlaygroundCompletionAsResponseAsync(
            string agentId,
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse2>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 402)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.AgentPlaygroundCompletionResponse7>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::RetellAI.AgentPlaygroundCompletionResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::RetellAI.AutoSDKHttpResponse<global::RetellAI.AgentPlaygroundCompletionResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::RetellAI.AgentPlaygroundCompletionResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
