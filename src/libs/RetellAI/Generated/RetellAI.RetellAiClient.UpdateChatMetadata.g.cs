...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement s_UpdateChatMetadataSecurityRequirement0 =
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement[] s_UpdateChatMetadataSecurityRequirements =
            new global::RetellAI.EndPointSecurityRequirement[]
            {                s_UpdateChatMetadataSecurityRequirement0,
            };
        partial void PrepareUpdateChatMetadataArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string chatId,
            global::RetellAI.UpdateChatMetadataRequest request);
        partial void PrepareUpdateChatMetadataRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string chatId,
            global::RetellAI.UpdateChatMetadataRequest request);
        partial void ProcessUpdateChatMetadataResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.ChatResponse> UpdateChatMetadataAsync(
            string chatId,
        ...
        {
            var __response = await UpdateChatMetadataAsResponseAsync(
                chatId: chatId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.ChatResponse>> UpdateChatMetadataAsResponseAsync(
            string chatId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateChatMetadataArguments(
            ...
            var __authorizations = global::RetellAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateChatMetadataSecurityRequirements,
                operationName: "UpdateChatMetadataAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::RetellAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateChatMetadataAsync",
                                pathTemplate: "$\"/update-chat/{chatId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateChatMetadataResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::RetellAI.UpdateChatMetadataResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::RetellAI.UpdateChatMetadataResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdateChatMetadataResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::RetellAI.UpdateChatMetadataResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::RetellAI.UpdateChatMetadataResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdateChatMetadataResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::RetellAI.UpdateChatMetadataResponse3? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::RetellAI.UpdateChatMetadataResponse3.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdateChatMetadataResponse3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::RetellAI.UpdateChatMetadataResponse4? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::RetellAI.UpdateChatMetadataResponse4.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.UpdateChatMetadataResponse4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateChatMetadataResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await UpdateChatMetadataAsync(
                chatId: chatId,
                request: __request,
                requestOptions: requestOptions,
