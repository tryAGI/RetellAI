...
namespace RetellAI
{
    ...
    public sealed partial class GetContactResponse2
    {
        ...
        public global::RetellAI.GetContactResponseStatus2? Status { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetContactResponse2" /> class.
        /// </summary>
...
#endif
        public GetContactResponse2(
            global::RetellAI.GetContactResponseStatus2? status,
            string? message)
        {
            this.Status = status;
