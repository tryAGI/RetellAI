...
namespace RetellAI
{
    ...
    public sealed partial class GetVoiceResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.GetVoiceResponseStatus3JsonConverter))]
        public global::RetellAI.GetVoiceResponseStatus3? Status { get; set; }
        ...
        public GetVoiceResponse3(
            global::RetellAI.GetVoiceResponseStatus3? status,
            string? message)
        {
            this.Status = status;
