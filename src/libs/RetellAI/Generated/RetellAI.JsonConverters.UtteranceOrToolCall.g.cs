...
namespace RetellAI.JsonConverters
{
    ...
    public class UtteranceOrToolCallJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.UtteranceOrToolCall>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("time_sec")) __score6++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::RetellAI.InjectedUtterance? injected = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            if (utterance == null && invocation == null && result == null && nodeTransition == null && dtmf == null && sms == null && injected == null)
            {
                try
                {
