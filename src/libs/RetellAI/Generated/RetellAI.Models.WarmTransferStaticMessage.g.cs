...
namespace RetellAI
{
    ...
    public sealed partial class WarmTransferStaticMessage
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.WarmTransferStaticMessageTypeJsonConverter))]
        public global::RetellAI.WarmTransferStaticMessageType? Type { get; set; }
        ...
        public WarmTransferStaticMessage(
            global::RetellAI.WarmTransferStaticMessageType? type,
            string? message)
        {
            this.Type = type;
