...
namespace RetellAI
{
    ...
    public sealed partial class CreateWebCallResponse4
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.CreateWebCallResponseStatus4JsonConverter))]
        public global::RetellAI.CreateWebCallResponseStatus4? Status { get; set; }
        ...
        public CreateWebCallResponse4(
            global::RetellAI.CreateWebCallResponseStatus4? status,
            string? message)
        {
            this.Status = status;
