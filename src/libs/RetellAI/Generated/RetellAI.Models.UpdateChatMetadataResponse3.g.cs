...
namespace RetellAI
{
    ...
    public sealed partial class UpdateChatMetadataResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.UpdateChatMetadataResponseStatus3JsonConverter))]
        public global::RetellAI.UpdateChatMetadataResponseStatus3? Status { get; set; }
        ...
        public UpdateChatMetadataResponse3(
            global::RetellAI.UpdateChatMetadataResponseStatus3? status,
            string? message)
        {
            this.Status = status;
