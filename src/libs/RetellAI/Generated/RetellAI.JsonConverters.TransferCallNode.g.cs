...
{
    /// <inheritdoc />
    public class TransferCallNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.TransferCallNode>
    {
        /// <inheritdoc />
        public override global::RetellAI.TransferCallNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::RetellAI.TransferCallNodeVariant2? transferCallNodeVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.TransferCallNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.TransferCallNodeVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.TransferCallNodeVariant2).Name}");
            ...
            var __value = new global::RetellAI.TransferCallNode(
                @base,
        ...
        public override void Write(
            ...
            global::RetellAI.TransferCallNode value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
