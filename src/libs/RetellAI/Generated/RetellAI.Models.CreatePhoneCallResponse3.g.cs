...
namespace RetellAI
{
    ...
    public sealed partial class CreatePhoneCallResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.CreatePhoneCallResponseStatus3JsonConverter))]
        public global::RetellAI.CreatePhoneCallResponseStatus3? Status { get; set; }
        ...
        public CreatePhoneCallResponse3(
            global::RetellAI.CreatePhoneCallResponseStatus3? status,
            string? message)
        {
            this.Status = status;
