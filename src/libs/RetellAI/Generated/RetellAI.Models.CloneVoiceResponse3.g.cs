...
namespace RetellAI
{
    ...
    public sealed partial class CloneVoiceResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.CloneVoiceResponseStatus3JsonConverter))]
        public global::RetellAI.CloneVoiceResponseStatus3? Status { get; set; }
        ...
        public CloneVoiceResponse3(
            global::RetellAI.CloneVoiceResponseStatus3? status,
            string? message)
        {
            this.Status = status;
