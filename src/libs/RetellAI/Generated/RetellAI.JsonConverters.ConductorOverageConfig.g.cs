...
{
    /// <inheritdoc />
    public class ConductorOverageConfigJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.ConductorOverageConfig>
    {
        /// <inheritdoc />
        public override global::RetellAI.ConductorOverageConfig Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score2 = 0;
            if (__jsonProps.Contains("mode")) __score2++;
            if (__jsonProps.Contains("monthly_limit_usd")) __score2++;
            var __bestScore = 0;
            var __bestIndex = -1;
            ...
            global::RetellAI.ConductorOverageConfigVariant1? conductorOverageConfigVariant1 = default;
            global::RetellAI.ConductorOverageConfigVariant2? conductorOverageConfigVariant2 = default;
            global::RetellAI.ConductorOverageConfigVariant3? conductorOverageConfigVariant3 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        conductorOverageConfigVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        conductorOverageConfigVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
                ...
                else if (__bestIndex == 2)
                {
                    try
                    {
                        ...
                        conductorOverageConfigVariant3 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (conductorOverageConfigVariant1 == null && conductorOverageConfigVariant2 == null && conductorOverageConfigVariant3 == null)
            {
                try
                {
            ...
            var __value = new global::RetellAI.ConductorOverageConfig(
        ...
        public override void Write(
            ...
            global::RetellAI.ConductorOverageConfig value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsConductorOverageConfigVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ConductorOverageConfigVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.ConductorOverageConfigVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.ConductorOverageConfigVariant1).Name}");
