...
namespace RetellAI
{
    ...
    public sealed partial class Equation
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.EquationOperatorJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::RetellAI.EquationOperator Operator { get; set; }
        ...
        public Equation(
            string left,
            global::RetellAI.EquationOperator @operator,
            string? right)
        {
