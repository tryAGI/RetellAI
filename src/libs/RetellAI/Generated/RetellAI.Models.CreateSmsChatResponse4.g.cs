...
namespace RetellAI
{
    ...
    public sealed partial class CreateSmsChatResponse4
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.CreateSmsChatResponseStatus4JsonConverter))]
        public global::RetellAI.CreateSmsChatResponseStatus4? Status { get; set; }
        ...
        public CreateSmsChatResponse4(
            global::RetellAI.CreateSmsChatResponseStatus4? status,
            string? message)
        {
            this.Status = status;
