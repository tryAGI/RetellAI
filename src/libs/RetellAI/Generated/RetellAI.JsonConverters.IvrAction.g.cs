...
{
    /// <inheritdoc />
    public class IvrActionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.IvrAction>
    {
        /// <inheritdoc />
        public override global::RetellAI.IvrAction Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::RetellAI.IvrActionHangup? hangup = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::RetellAI.IvrAction(
                hangup
                );
        ...
        public override void Write(
            ...
            global::RetellAI.IvrAction value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
