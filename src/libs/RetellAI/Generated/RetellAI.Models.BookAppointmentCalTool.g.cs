...
namespace RetellAI
{
    ...
    public sealed partial class BookAppointmentCalTool
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.BookAppointmentCalToolTypeJsonConverter))]
        ...
        /// <summary>
        /// Timezone to be used when booking appointment, must be in [IANA timezone database](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones). Can also be a dynamic variable in the format `{{variable_name}}` that will be resolved at runtime. If not specified, will check if user specified timezone in call, and if not, will use the timezone of the Retell servers.
        /// </summary>
...
#endif
        public BookAppointmentCalTool(
            string name,
            string calApiKey,
            global::RetellAI.OneOf<double?, string> eventTypeId,
            global::RetellAI.BookAppointmentCalToolType type,
            string? description,
            string? timezone)
        {
