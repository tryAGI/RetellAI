...
{
    /// <inheritdoc />
    public class BridgeTransferNodeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.BridgeTransferNode>
    {
        /// <inheritdoc />
        public override global::RetellAI.BridgeTransferNode Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::RetellAI.BridgeTransferNodeVariant2? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.BridgeTransferNodeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.BridgeTransferNodeVariant2> ??
        ...
        public override void Write(
            ...
            global::RetellAI.BridgeTransferNode value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
