...
{
    /// <inheritdoc />
    public class AppUsageResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.AppUsageResponse>
    {
        /// <inheritdoc />
        public override global::RetellAI.AppUsageResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("agent_name")) __score0++;
            if (__jsonProps.Contains("agent_versions")) __score0++;
            if (__jsonProps.Contains("configured_timestamp")) __score0++;
            if (__jsonProps.Contains("type")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("configured_timestamp")) __score1++;
            if (__jsonProps.Contains("knowledge_base_id")) __score1++;
            if (__jsonProps.Contains("knowledge_base_name")) __score1++;
            ...
            global::RetellAI.AgentAppUsage? agent = default;
            global::RetellAI.KnowledgeBaseAppUsage? knowledgeBase = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        knowledgeBase = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (agent == null && knowledgeBase == null)
            {
                try
                {
            ...
            var __value = new global::RetellAI.AppUsageResponse(
                agent,
        ...
        public override void Write(
            ...
            global::RetellAI.AppUsageResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
