    ...
    public static class NullableLLMModelExtensions
    {
        ...
        public static string ToValueString(this NullableLLMModel value)
        {
            return value switch
            {
                ...
                NullableLLMModel.Gemini37Flash => "gemini-3.7-flash",
                NullableLLMModel.Gemini38Flash => "gemini-3.8-flash",
        ...
        public static NullableLLMModel? ToEnum(string value)
        {
            return value switch
            {
                ...
                "gemini-3.7-flash" => NullableLLMModel.Gemini37Flash,
                "gemini-3.8-flash" => NullableLLMModel.Gemini38Flash,
