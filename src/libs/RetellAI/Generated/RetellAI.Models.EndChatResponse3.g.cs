...
namespace RetellAI
{
    ...
    public sealed partial class EndChatResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.EndChatResponseStatus3JsonConverter))]
        public global::RetellAI.EndChatResponseStatus3? Status { get; set; }
        ...
        public EndChatResponse3(
            global::RetellAI.EndChatResponseStatus3? status,
            string? message)
        {
            this.Status = status;
