...
namespace RetellAI
{
    ...
    public sealed partial class MCPTool
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.MCPToolTypeJsonConverter))]
        public global::RetellAI.MCPToolType Type { get; set; }
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.MCPToolExecutionMessageTypeJsonConverter))]
        public global::RetellAI.MCPToolExecutionMessageType? ExecutionMessageType { get; set; }

        /// <summary>
        /// If true, play a typing sound on the agent audio track while this MCP tool is executing.
        /// </summary>
        ...
        public MCPTool(
            string name,
            string description,
            global::RetellAI.MCPToolType type,
            string? mcpId,
