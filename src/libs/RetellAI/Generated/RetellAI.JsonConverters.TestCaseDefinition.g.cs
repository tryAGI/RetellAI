...
{
    /// <inheritdoc />
    public class TestCaseDefinitionJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.TestCaseDefinition>
    {
        /// <inheritdoc />
        public override global::RetellAI.TestCaseDefinition Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("llm_model")) __score0++;
            if (__jsonProps.Contains("metrics")) __score0++;
            if (__jsonProps.Contains("name")) __score0++;
            if (__jsonProps.Contains("response_engine")) __score0++;
            if (__jsonProps.Contains("tool_mocks")) __score0++;
            if (__jsonProps.Contains("user_prompt")) __score0++;
            var __score1 = 0;
            if (__jsonProps.Contains("creation_timestamp")) __score1++;
            if (__jsonProps.Contains("test_case_definition_id")) __score1++;
            ...
            global::RetellAI.TestCaseDefinitionInput? input = default;
            global::RetellAI.TestCaseDefinitionVariant2? testCaseDefinitionVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::RetellAI.TestCaseDefinition(
                input,
        ...
        public override void Write(
            ...
            global::RetellAI.TestCaseDefinition value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
