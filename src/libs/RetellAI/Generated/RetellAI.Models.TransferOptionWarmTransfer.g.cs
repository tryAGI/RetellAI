...
namespace RetellAI
{
    ...
    public sealed partial class TransferOptionWarmTransfer
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.TransferOptionWarmTransferTypeJsonConverter))]
        public global::RetellAI.TransferOptionWarmTransferType Type { get; set; }
        ...
        public TransferOptionWarmTransfer(
            global::RetellAI.TransferOptionWarmTransferType type,
