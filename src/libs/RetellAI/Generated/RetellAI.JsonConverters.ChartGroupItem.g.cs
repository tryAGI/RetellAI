...
{
    /// <inheritdoc />
    public class ChartGroupItemJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.ChartGroupItem>
    {
        /// <inheritdoc />
        public override global::RetellAI.ChartGroupItem Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("field")) __score1++;
            ...
            global::RetellAI.ChartGroupItemVariant1? chartGroupItemVariant1 = default;
            global::RetellAI.ChartGroupItemVariant2? chartGroupItemVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        chartGroupItemVariant1 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        chartGroupItemVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (chartGroupItemVariant1 == null && chartGroupItemVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::RetellAI.ChartGroupItem(
        ...
        public override void Write(
            ...
            global::RetellAI.ChartGroupItem value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsChartGroupItemVariant1)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ChartGroupItemVariant1), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.ChartGroupItemVariant1?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.ChartGroupItemVariant1).Name}");
