...
{
    /// <inheritdoc />
    public class RetellLlmRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.RetellLlmRequest>
    {
        /// <inheritdoc />
        public override global::RetellAI.RetellLlmRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("general_prompt")) __score1++;
            if (__jsonProps.Contains("general_tools")) __score1++;
            ...
            global::RetellAI.RetellLlmOverride? @override = default;
            global::RetellAI.RetellLlmRequestVariant2? retellLlmRequestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::RetellAI.RetellLlmRequest(
                @override,
        ...
        public override void Write(
            ...
            global::RetellAI.RetellLlmRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsRetellLlmRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.RetellLlmRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.RetellLlmRequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.RetellLlmRequestVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.RetellLlmRequestVariant2!, typeInfo);
            }
        }
    }
}