...
namespace RetellAI
{
    ...
    public sealed partial class AddCommunityVoiceRequest
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.AddCommunityVoiceRequestVoiceProviderJsonConverter))]
        public global::RetellAI.AddCommunityVoiceRequestVoiceProvider? VoiceProvider { get; set; }
