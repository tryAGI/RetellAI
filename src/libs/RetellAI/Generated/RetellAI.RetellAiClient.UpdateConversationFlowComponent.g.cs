...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement[] s_UpdateConversationFlowComponentSecurityRequirements =
            new global::RetellAI.EndPointSecurityRequirement[]
            {                s_UpdateConversationFlowComponentSecurityRequirement0,
            };
        ...
        partial void PrepareUpdateConversationFlowComponentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string conversationFlowComponentId,
            global::RetellAI.ConversationFlowComponent request);
        partial void ProcessUpdateConversationFlowComponentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateConversationFlowComponentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await UpdateConversationFlowComponentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.ConversationFlowComponentResponse>> UpdateConversationFlowComponentAsResponseAsync(
            string conversationFlowComponentId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateConversationFlowComponentArguments(
            ...
            var __authorizations = global::RetellAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateConversationFlowComponentSecurityRequirements,
                operationName: "UpdateConversationFlowComponentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::RetellAI.PathBuilder(
                                path: $"/update-conversation-flow-component/{conversationFlowComponentId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::RetellAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateConversationFlowComponentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateConversationFlowComponentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::RetellAI.UpdateConversationFlowComponentResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::RetellAI.UpdateConversationFlowComponentResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::RetellAI.ApiException<global::RetellAI.UpdateConversationFlowComponentResponse>(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::RetellAI.UpdateConversationFlowComponentResponse2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::RetellAI.UpdateConversationFlowComponentResponse2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::RetellAI.ApiException<global::RetellAI.UpdateConversationFlowComponentResponse2>(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::RetellAI.UpdateConversationFlowComponentResponse3? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::RetellAI.UpdateConversationFlowComponentResponse3.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::RetellAI.ApiException<global::RetellAI.UpdateConversationFlowComponentResponse3>(
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                throw new global::RetellAI.ApiException<global::RetellAI.UpdateConversationFlowComponentResponse4>(
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw new global::RetellAI.ApiException<global::RetellAI.UpdateConversationFlowComponentResponse5>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateConversationFlowComponentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
