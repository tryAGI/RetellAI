...
namespace RetellAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::RetellAI.AutoSDKRetryOptions Retry { get; set; } = new global::RetellAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::RetellAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::RetellAI.IAutoSDKHook>();
        ...
        public global::RetellAI.AutoSDKClientOptions AddHook(
            global::RetellAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::RetellAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::RetellAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::RetellAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::RetellAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::RetellAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::RetellAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::RetellAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::RetellAI.AutoSDKAuthorizationValue>?> ResolveAsync(
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::RetellAI.AutoSDKHook
    {
        /// <inheritdoc />
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::RetellAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::RetellAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::RetellAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::RetellAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::RetellAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::RetellAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    internal static class AutoSDKRequestOptionsSupport
    {
        internal static global::RetellAI.AutoSDKHookContext CreateHookContext(
            ...
            global::RetellAI.AutoSDKClientOptions clientOptions,
            global::RetellAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::RetellAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::RetellAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::RetellAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::RetellAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::RetellAI.IAutoSDKHook, global::RetellAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::RetellAI.AutoSDKHookContext context)
        {
