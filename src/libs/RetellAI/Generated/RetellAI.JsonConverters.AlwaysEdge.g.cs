...
{
    /// <inheritdoc />
    public class AlwaysEdgeJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.AlwaysEdge>
    {
        /// <inheritdoc />
        public override global::RetellAI.AlwaysEdge Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::RetellAI.AlwaysEdgeVariant2? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.AlwaysEdgeVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.AlwaysEdgeVariant2> ??
        ...
        public override void Write(
            ...
            global::RetellAI.AlwaysEdge value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
