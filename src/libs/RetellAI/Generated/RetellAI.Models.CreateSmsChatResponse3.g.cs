...
namespace RetellAI
{
    ...
    public sealed partial class CreateSmsChatResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.CreateSmsChatResponseStatus3JsonConverter))]
        public global::RetellAI.CreateSmsChatResponseStatus3? Status { get; set; }
        ...
        public CreateSmsChatResponse3(
            global::RetellAI.CreateSmsChatResponseStatus3? status,
            string? message)
        {
            this.Status = status;
