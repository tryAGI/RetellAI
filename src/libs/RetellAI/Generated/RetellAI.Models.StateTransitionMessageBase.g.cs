...
namespace RetellAI
{
    ...
    public sealed partial class StateTransitionMessageBase
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.StateTransitionMessageBaseRoleJsonConverter))]
        public global::RetellAI.StateTransitionMessageBaseRole Role { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StateTransitionMessageBase" /> class.
        /// </summary>
...
#endif
        public StateTransitionMessageBase(
            string? messageId,
            global::RetellAI.StateTransitionMessageBaseRole role,
