...
namespace RetellAI
{
    ...
    public sealed partial class UpdateCallMetadataResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.UpdateCallMetadataResponseStatus3JsonConverter))]
        public global::RetellAI.UpdateCallMetadataResponseStatus3? Status { get; set; }
        ...
        public UpdateCallMetadataResponse3(
            global::RetellAI.UpdateCallMetadataResponseStatus3? status,
            string? message)
        {
            this.Status = status;
