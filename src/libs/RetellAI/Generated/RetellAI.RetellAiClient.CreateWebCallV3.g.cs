...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement s_CreateWebCallV3SecurityRequirement0 =
        ...
        private static readonly global::RetellAI.EndPointSecurityRequirement[] s_CreateWebCallV3SecurityRequirements =
            new global::RetellAI.EndPointSecurityRequirement[]
            {                s_CreateWebCallV3SecurityRequirement0,
            };
        partial void PrepareCreateWebCallV3Arguments(
            global::System.Net.Http.HttpClient httpClient,
            global::RetellAI.CreateWebCallV3Request request);
        partial void PrepareCreateWebCallV3Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::RetellAI.CreateWebCallV3Request request);
        partial void ProcessCreateWebCallV3Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateWebCallV3ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.V3CreateWebCallResponse> CreateWebCallV3Async(

            global::RetellAI.CreateWebCallV3Request request,
            global::RetellAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateWebCallV3AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.V3CreateWebCallResponse>> CreateWebCallV3AsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateWebCallV3Arguments(
            ...
            var __authorizations = global::RetellAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateWebCallV3SecurityRequirements,
                operationName: "CreateWebCallV3Async");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::RetellAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateWebCallV3",
                                methodName: "CreateWebCallV3Async",
                                pathTemplate: "\"/v3/create-web-call\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateWebCallV3Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::RetellAI.CreateWebCallV3Response.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response2? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::RetellAI.CreateWebCallV3Response2.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 402)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response3? __value_402 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_402 = global::RetellAI.CreateWebCallV3Response3.FromJson(__content_402, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_402 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response3>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 422)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response4? __value_422 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_422 = global::RetellAI.CreateWebCallV3Response4.FromJson(__content_422, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_422 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response4>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 429)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response5? __value_429 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_429 = global::RetellAI.CreateWebCallV3Response5.FromJson(__content_429, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_429 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response5>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                global::RetellAI.CreateWebCallV3Response6? __value_500 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_500 = global::RetellAI.CreateWebCallV3Response6.FromJson(__content_500, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_500 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreateWebCallV3Response6>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateWebCallV3ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::RetellAI.V3CreateWebCallResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::RetellAI.AutoSDKHttpResponse<global::RetellAI.V3CreateWebCallResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::RetellAI.V3CreateWebCallResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.V3CreateWebCallResponse> CreateWebCallV3Async(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::RetellAI.CreateWebCallV3Request
            {
                AgentId = agentId,
            ...
            return await CreateWebCallV3Async(
                request: __request,
                requestOptions: requestOptions,
