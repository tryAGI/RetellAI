...
namespace RetellAI
{
    ...
    public sealed partial class DeleteAgentResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.DeleteAgentResponseStatus3JsonConverter))]
        public global::RetellAI.DeleteAgentResponseStatus3? Status { get; set; }
        ...
        public DeleteAgentResponse3(
            global::RetellAI.DeleteAgentResponseStatus3? status,
            string? message)
        {
            this.Status = status;
