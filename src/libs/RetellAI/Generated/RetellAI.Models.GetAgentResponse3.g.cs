...
namespace RetellAI
{
    ...
    public sealed partial class GetAgentResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.GetAgentResponseStatus3JsonConverter))]
        public global::RetellAI.GetAgentResponseStatus3? Status { get; set; }
        ...
        public GetAgentResponse3(
            global::RetellAI.GetAgentResponseStatus3? status,
            string? message)
        {
            this.Status = status;
