...
{
    /// <inheritdoc />
    public class ResponseEngineJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::RetellAI.ResponseEngine>
    {
        /// <inheritdoc />
        public override global::RetellAI.ResponseEngine Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score1 = 0;
            if (__jsonProps.Contains("llm_websocket_url")) __score1++;
            if (__jsonProps.Contains("type")) __score1++;
            var __score2 = 0;
            if (__jsonProps.Contains("conversation_flow_id")) __score2++;
            ...
            global::RetellAI.ResponseEngineRetellLm? retellLm = default;
            global::RetellAI.ResponseEngineCustomLm? customLm = default;
            global::RetellAI.ResponseEngineConversationFlow? conversationFlow = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        retellLm = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ResponseEngineCustomLm), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.ResponseEngineCustomLm> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::RetellAI.ResponseEngineCustomLm).Name}");
                        customLm = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (retellLm == null && customLm == null && conversationFlow == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::RetellAI.ResponseEngineRetellLm), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::RetellAI.ResponseEngineRetellLm> ??
            ...
            var __value = new global::RetellAI.ResponseEngine(
                retellLm,
        ...
        public override void Write(
            ...
            global::RetellAI.ResponseEngine value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
