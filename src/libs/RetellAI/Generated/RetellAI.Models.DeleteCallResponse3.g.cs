...
namespace RetellAI
{
    ...
    public sealed partial class DeleteCallResponse3
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::RetellAI.JsonConverters.DeleteCallResponseStatus3JsonConverter))]
        public global::RetellAI.DeleteCallResponseStatus3? Status { get; set; }
        ...
        public DeleteCallResponse3(
            global::RetellAI.DeleteCallResponseStatus3? status,
            string? message)
        {
            this.Status = status;
