...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::RetellAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::RetellAI.AutoSDKHttpResponse<global::RetellAI.PhoneNumberResponse>> CreatePhoneNumberAsResponseAsync(
                ...
                else
                {
                    await global::RetellAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse>.Create(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse2>.Create(
                                    statusCode: __response.StatusCode,
                            ...
                            if ((int)__response.StatusCode == 500)
                            {
                                ...
                                throw global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse3>.Create(
                                    statusCode: __response.StatusCode,
