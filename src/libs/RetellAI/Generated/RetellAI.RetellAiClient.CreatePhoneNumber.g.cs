...
namespace RetellAI
{
    public partial class RetellAiClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.PhoneNumberResponse> CreatePhoneNumberAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if ((int)__response.StatusCode == 400)
            {
                ...
                global::RetellAI.CreatePhoneNumberResponse? __value_400 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_400 = global::RetellAI.CreatePhoneNumberResponse.FromJson(__content_400, JsonSerializerContext);
                    }
                    else
                    {
                        __content_400 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse>(
            ...
            if ((int)__response.StatusCode == 401)
            {
                ...
                global::RetellAI.CreatePhoneNumberResponse2? __value_401 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_401 = global::RetellAI.CreatePhoneNumberResponse2.FromJson(__content_401, JsonSerializerContext);
                    }
                    else
                    {
                        __content_401 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse2>(
            ...
            if ((int)__response.StatusCode == 500)
            {
                ...
                global::RetellAI.CreatePhoneNumberResponse3? __value_500 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_500 = global::RetellAI.CreatePhoneNumberResponse3.FromJson(__content_500, JsonSerializerContext);
                    }
                    else
                    {
                        __content_500 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::RetellAI.ApiException<global::RetellAI.CreatePhoneNumberResponse3>(
        ...
        public async global::System.Threading.Tasks.Task<global::RetellAI.PhoneNumberResponse> CreatePhoneNumberAsync(
            ...
            global::RetellAI.CreatePhoneNumberRequestNumberProvider? numberProvider = default,
            global::RetellAI.CreatePhoneNumberRequestCountryCode? countryCode = default,
